...
1.12 				:class:`setlyze.report.ReportGenerator`
...
1.30 				:class:`setlyze.report.ReportGenerator`
...
1.48 				:class:`setlyze.report.ReportGenerator`
1.49 				:class:`setlyze.report.ReportReader`
1.50 				:meth:`setlyze.report.ReportGenerator.set_location_selections`
1.51 				:meth:`setlyze.report.ReportGenerator.set_species_selections`
1.52 				:meth:`setlyze.report.ReportGenerator.set_spot_distances_observed`
1.53 				:meth:`setlyze.report.ReportGenerator.set_spot_distances_expected`
1.54 				:meth:`setlyze.report.ReportGenerator.set_plate_areas_definition`
1.55 				:meth:`setlyze.report.ReportGenerator.set_area_totals_observed`
1.56 				:meth:`setlyze.report.ReportGenerator.set_area_totals_expected`
...
1.62 				:meth:`setlyze.analysis.spot_preference.Start.set_plate_area_totals_observed`
1.63 				:meth:`setlyze.analysis.spot_preference.Start.set_plate_area_totals_expected`
1.64 				:meth:`setlyze.analysis.spot_preference.Start.get_defined_areas_totals_observed`
1.65 				:meth:`setlyze.analysis.spot_preference.Start.repeat_test`
...
1.70 				:meth:`setlyze.report.ReportGenerator.set_statistics`
1.71                :meth:`setlyze.report.ReportGenerator.set_statistics_repeats`
1.72 				:meth:`setlyze.report.ReportGenerator.set_analysis`
...
1.98 				:meth:`setlyze.analysis.spot_preference.Start.calculate_significance_wilcoxon`
1.99 				:meth:`setlyze.analysis.spot_preference.Start.calculate_significance_chisq`
1.100 				:meth:`setlyze.analysis.spot_preference.Start.calculate_significance_wilcoxon_repeats`
1.101 				:meth:`setlyze.analysis.spot_preference.Start.get_area_probabilities`
1.102 				:meth:`setlyze.analysis.attraction_intra.Start.calculate_significance_for_repeats`
1.103 				:meth:`setlyze.analysis.attraction_intra.Start.repeat_test`
1.104 				:meth:`setlyze.analysis.attraction_inter.Start.calculate_significance_for_repeats`
1.105 				:meth:`setlyze.analysis.attraction_inter.Start.repeat_test`
==================  =================================
